...
<body>
 ...
 <div class="dropdown">
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('admissions.store', ['institutionId' => $institution->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="institution_id">Institution ID:</label>
                <input type="text" id="institution_id" name="institution_id" value="{{ $institution->id }}" readonly class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="details" name="details" rows="5" required class="form-control"></textarea>
            </div>
            <div class="form-group">
                <label for="document">Upload Document (PDF):</label>
                <input type="file" id="document" name="document" accept=".pdf" required class="form-control">
            </div>
            <button type="submit" class="btn btn-primary mt-3">Upload Admission</button>
        </form>

        <div class="note mt-4">
            <p><strong>Note:</strong> Ensure that all fields are filled out correctly before submitting.</p>
        </div>
    </div>
