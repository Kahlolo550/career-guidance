            ...
            <div class="col-md-6">
                <div class="feature card">
                    <div class="card-body">
                        ...
                        <p>Easily organize and manage the faculties in your institution. Add, update, and delete faculty information as needed.</p>
                        <a href="{{ route('institution.faculties.create') }}" class="btn btn-secondary">Add Faculty</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="feature card">
                    <div class="card-body">
                        ...
                        <p>Showcase your institution's admissions to potential students. Include detailed descriptions and requirements.</p>
